...
s+1
 #mathamatical operations on Series 
...
s.loc['a':'c'] 
#accessing value using index name using slicing and loc #range is included
...
s.iloc[0] 
#accessing value using index number and iloc 
...
s.iloc[0:3]
 #accessing value using index number and iloc slicing 
#range is excluded
...
s[s.index%2==1] 
#return record which are having odd index
...
s[15]=100 
#added new record as 15 is not present in index
